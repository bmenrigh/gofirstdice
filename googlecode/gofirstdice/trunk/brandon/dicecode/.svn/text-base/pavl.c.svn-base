...
/* $Id: pavl.c 37 2011-05-22 03:35:55Z bmenrigh@ucsd.edu $ */
...
struct pavl_table *
pavl_create (pavl_comparison_func *compare, void *param,
...
void *
pavl_find (const struct pavl_table *tree, const void *item)
{
...
void *
pavl_insert (struct pavl_table *table, void *item)
{
...
void *
pavl_replace (struct pavl_table *table, void *item)
{
  void **p = pavl_probe (table, item);
  if (p == NULL || *p == item)
    return NULL;
...
pavl_delete (struct pavl_table *tree, const void *item)
{
  ...
  int dir = 0;             /* Side of |q| on which |p| is linked. */
...
void
pavl_destroy (struct pavl_table *tree, pavl_item_func *destroy)
{
  struct pavl_node *p, *q;

  assert (tree != NULL);

  for (p = tree->pavl_root; p != NULL; p = q)
...
void *
pavl_malloc (struct libavl_allocator *allocator, size_t size)
{
...
/* Frees |block|. */
void
pavl_free (struct libavl_allocator *allocator, void *block)
{
...
void
(pavl_assert_insert) (struct pavl_table *table, void *item)
{
  void **p = pavl_probe (table, item);
...
void *
(pavl_assert_delete) (struct pavl_table *table, void *item)
{
